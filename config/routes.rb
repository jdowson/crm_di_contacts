...
ActionController::Routing::Routes.draw do |map|
  map.namespace :admin do |admin|
    ...
    admin.resources :lookups, :collection => { :search => :get, :auto_complete => :post }, :member => { :unpublish => :put, :publish => :put, :inactivate => :put, :activate => :put, :confirm => :get, :cacheupdate => :put }, :except => :show, :requirements => { :lookup_id => nil }  do |lookup|

      lookup.resources :lookups, :name_prefix => "admin_child_", :as => "children", :collection => { :search => :get, :auto_complete => :post }, :member => { :unpublish => :put, :publish => :put, :inactivate => :put, :activate => :put, :confirm => :get, :cacheupdate => :put }, :except => :show
